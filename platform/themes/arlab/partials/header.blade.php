...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body @if (BaseHelper::siteLanguageDirection() == 'rtl') dir="rtl" @endif class="@if (BaseHelper::siteLanguageDirection() == 'rtl') rtl @endif header_full_true arlab-template css_scrollbar lazy_icons btnt4_style_2 zoom_tp_2 css_scrollbar template-index arlab_toolbar_true hover_img2 swatch_style_rounded swatch_list_size_small label_style_rounded wrapper_full_width header_full_true header_sticky_true hide_scrolld_true des_header_3 h_banner_true top_bar_true prs_bordered_grid_1 search_pos_canvas lazyload @if (Theme::get('bodyClass')) {{ Theme::get('bodyClass') }} @endif">
                            ...
                            <div class="header-action-right d-block d-lg-none">
                                <div class="header-action-2">
                                    ...
                                    @if (EcommerceHelper::isWishlistEnabled())
                                        <div class="header-action-icon-2">
                                            <a href="{{ route('public.wishlist') }}" class="wishlist-count">
                                                <img alt="arlab" src="{{ Theme::asset()->url('images/icons/icon-heart-white.svg') }}">
                                    ...
                                    <div class="header-action-icon-2">
                                        <a href="{{ route('customer.login') }}">
                                            <img alt="arlab" src="{{ Theme::asset()->url('images/icons/icon-user-white.svg') }}">
                                        </a>
                                    </div>
